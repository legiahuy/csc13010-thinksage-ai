...
echo "Starting video rendering test..."

# Create necessary directories
echo "Setting up directories..."
mkdir -p remotion public app/_components data
chmod -R 755 remotion public app/_components data
...
VIDEO_DATA_BASE64=$(echo -n "$VIDEO_DATA" | base64)
